...
4. ⏳ After merge: smoke-test the live URL and record it in public project metadata.
...
- `docs/backlog.md` records the remaining post-merge closure gate.
...
- [ ] Merge the Pages deployment PR and wait for the `main` Pages workflow.
- [ ] Smoke-test login and the deterministic trading journey at the HTTPS Pages URL.
- [ ] Add the verified live-demo link to the README and repository homepage, then close MF-13.
